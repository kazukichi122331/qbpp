...
import random
import math
from archive.cvrp.plot_tour import extract_routes, plot_routes
...
f_dl = objective + P * qbpp.cons(constraints)
...
g_dl.simplify_as_binary()

solver = qbpp.ABS3Solver(g_dl)
...
plot_routes(nodes,routes,"dl_cvrp")

print("energy = ", sol(g_dl))
print("violation = ", g_dl.cons(sol))
