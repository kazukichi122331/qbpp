...
from archive.tsp.nodes import ran_nodes, distance
from archive.tsp.plot_tour import plot_tour
...
for loop in range(LOOP):
    ...
    solg = sol(g)
    violation = sol(row_constraint+col_constraint+mtz_constraint)
...
for loop in range(LOOP):
    ...
    print(f"solve{loop+1}:")
    print(f"cons_energy = {cons_solg}, ", end="")
    print("violated constraints =", cons_violation)
