...
from archive.tsptw.archive.travel_time import travel_time
from archive.tsptw.archive.tsptw_plot import plot_tour
from archive.tsptw.archive.time_nodes import time_nodes_10, time_nodes_8, time_nodes_5
...
f = objective + P*qbpp.cons(constraints)
